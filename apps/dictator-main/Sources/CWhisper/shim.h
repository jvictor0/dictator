...
#include <whisper.h>
#elif __has_include("/opt/homebrew/Cellar/whisper-cpp/1.8.3/libexec/include/whisper.h")
...
#else
#error "whisper.h not found. Install whisper-cpp or provide pkg-config for whisper."
#endif
